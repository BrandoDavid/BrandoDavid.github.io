...
function Registrar() {
    if (txtNom.value=="" || txtNom.value==null) {
        alert("Ingresa sus nombres");
        txtNom.focus();
    }else if (txtApe.value=="" || txtApe.value==null) {
        alert("Ingresa sus apellidos");
        txtApe.focus();
    }else if (txtCor.value=="" || txtCor.value==null) {
        alert("Ingresa su correo");
        txtCor.focus();
    }else {
    // Capturando valores
...
// Asignamos al procedimiento en el boton
